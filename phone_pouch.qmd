...
1.  Align the 8 x 14 cm nylon dirt-out panel to one long edge of a 14cm strip of hook-and-loop. Overlap the panels about 5mm. Lightly tack the pieces together.
...
1.  Align a 14 cm piece of loop strip with the lower hem, centering the loop strip on the pouch panel. Stitch all edges of the loop strip.
